 ...
 * @author milea
 */
public class FormUser extends MainFrame {
        ...
        if (username.isEmpty() || fullname.isEmpty()) {
            ...
            try {
                ...
                if (obj instanceof UsersView) {
                    ((UsersView) obj).loadTabel();
                } else {
                    System.out.println("Ini bukan instance!!!");
                }
                this.peringatan("Berhasil menyimpan data users! Password user " + username + " adalah '" + plainPassword + "'");
                this.dispose();
            } catch (Exception e) {
                System.out.println(e.getMessage());
                this.peringatan("Gagal menyimpan data users!");
