...
import Output.Tesis.FormCariSkripsi;
 ...
 * @author milea
 */
public class FormPeminjamanSkripsi extends MainFrame {
     ...
     */
    public FormPeminjamanSkripsi() {
        this.dispose();
    }

    public FormPeminjamanSkripsi(Object obj, int userId) {
        this.userId = userId;
        this.obj = obj;
        initComponents();
    }
    ...
    public void setTesisId(int tesisId) {
        ...
        this.skripsi = getTesisById.getSingleResult();
        inputSkripsi.setText(this.skripsi.getJudul());
    ...
    public void setMahasiswaId(int mahasiswaId) {
        ...
        getStudentById.setParameter("studentId", mahasiswaId);
        this.mahasiswa = getStudentById.getSingleResult();
    ...
    private void initComponents() {
        ...
        inputSkripsi = new javax.swing.JTextField();
        ...
        jLabel1.setText("Form Peminjaman Skripsi");
        ...
        inputSkripsi.setEditable(false);
        inputSkripsi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                inputSkripsiMouseClicked(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(inputSkripsi, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(inputSkripsi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
    ...
    private void inputSkripsiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_inputSkripsiMouseClicked
        // TODO add your handling code here:
        new FormCariSkripsi(this, this.userId).setVisible(true);
    }//GEN-LAST:event_inputSkripsiMouseClicked
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.skripsi == null) {
            this.peringatan("Pilih skripsi yang ingin dipinjam terlebih dahulu!");
            ...
            try {
                ...
                Integer denda = Integer.valueOf(inputDenda.getText().trim());
                ...
                newPeminjaman.setBooksId(null);
                newPeminjaman.setTesisId(this.skripsi);
                ...
                this.skripsi.setBanyaknya(this.skripsi.getBanyaknya() - 1);
                this.skripsi.setUpdatedAt(date);
                entityManager.merge(skripsi);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPeminjamanSkripsi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPeminjamanSkripsi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField inputSkripsi;
